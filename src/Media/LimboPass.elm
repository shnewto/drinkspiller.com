...
collision =
    ...
    , description = "collision detection blooper reel, no locked axis"
    }


firstBlenderToBevy : Item
firstBlenderToBevy =
    { path = "/img/limbo-pass/first-blender-to-bevy.png"
...
ghostFormScene : Item
ghostFormScene =
    { path = "/img/limbo-pass/ghost-form-scene.png"
    ...
    , title = "ghostly form blender model reference"
    , description = ""
    }
...
gotItFigured : Item
gotItFigured =
    { path = "/img/limbo-pass/got-it-figured.png"
    ...
    , title = "procedural trimesh, winding order, normals, uvs"
    , description = ""
    }
...
gravityLol =
    ...
    , title = "collision detection blooper reel, gravity lol"
    , description = ""
    }
...
oppositeUvs : Item
oppositeUvs =
    { path = "/img/limbo-pass/opposite-uvs.png"
    ...
    , title = "not quite there with UVs"
    , description = ""
    }
...
sceneSet : Item
sceneSet =
    { path = "/img/limbo-pass/scene-set.png"
    ...
    , title = "silver map"
    , description = "blender models rendering in bevy"
    }


smallTerrain : Item
smallTerrain =
    { path = "/img/limbo-pass/small-terrain.png"
    ...
    , title = "first success with procedurally generated trimesh winding orders"
    , description = ""
    }
...
terrainScene : Item
terrainScene =
    { path = "/img/limbo-pass/terrain-scene.png"
    ...
    , title = "mountain terrain blender model reference"
    , description = ""
    }
...
terrain : Item
terrain =
    { path = "/img/limbo-pass/terrain.png"
...
triMeshExcitement =
    { path = "/img/limbo-pass/tri-mesh-excitement.png"
    ...
    , title = "an early attempt at procedurally generated trimesh terrain"
    , description = ""
    }

startingOut002 : Item
startingOut002 =
    { path = "/img/limbo-pass/starting-out-002.png"
    ...
    , title = "early concept limbo pass"
    , description = ""
    }
